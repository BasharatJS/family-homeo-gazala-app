...
export default function Hero() {
  ...
  return (
    <section
      id="home"
      className="relative overflow-hidden bg-lavender-50 pb-16 pt-32 sm:pb-20 sm:pt-36 lg:pt-40"
    >
      ...
      <div className="relative mx-auto grid max-w-6xl grid-cols-1 items-center gap-10 px-4 sm:px-6 lg:grid-cols-2 lg:gap-16 lg:px-8">
        <div>
        ...
        <div className="relative mx-auto w-full max-w-sm lg:max-w-none">
          <div className="aspect-[4/5] w-full overflow-hidden rounded-3xl border-8 border-white bg-violet-200 shadow-xl">
            <div className="flex h-full w-full items-center justify-center bg-violet-100">
              <Stethoscope className="h-24 w-24 text-violet-400" strokeWidth={1.25} />
            </div>
          </div>
